      ...
      local server = {
        settings = function(project_root, default_settings)
          ...
          return ra.load_rust_analyzer_settings(project_root, {
            settings_file_pattern = ".rust-analyzer.json", -- changed from "rust-analyzer.json"
...
--
-- local function load_rust_analyzer_settings(root_dir)
--   local path = root_dir .. "/.rust-analyzer.json"
...
--     vim.notify("Invalid .rust-analyzer.json", vim.log.levels.WARN)
--     return {}
--   end
--   vim.notifiy(vim.inspect(decoded), vim.log.levels.WARN)
--
--   return decoded
-- end
--
...
--         ---@type AstroLSPOpts
--         opts = {
--           handlers = { rust_analyzer = true }, -- disable setup of `rust_analyzer`
--           tools = {
...
--           local merge_table = require("astrocore").extend_tbl(default_settings or {}, astrolsp_settings)
--           local ra = require "rustaceanvim.config.server"
--           local project_settings = load_rust_analyzer_settings(project_root)
--
--           -- return {
--           --   ["rust-analyzer"] = project_settings,
--           -- }
--           -- load_rust_analyzer_settings merges any found settings with the passed in default settings table and then returns that table
--           local config = ra.load_rust_analyzer_settings(project_root, {
--             settings_file_pattern = "rust-analyzer.json",
--             default_settings = merge_table,
--           })
--           config["rust-analyzer"] = project_settings
--           return config
--         end,
--       }
--       local final_server = require("astrocore").extend_tbl(astrolsp_opts, server)
